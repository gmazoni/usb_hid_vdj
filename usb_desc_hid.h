...
#include <usb.h>
   ...
   const char USB_CLASS_SPECIFIC_DESC[] = {
      ...
      0x29, USB_EP1_TX_SIZE,        // Usage maximum

      0x15, 0x80,        // Logical minimum (-128)
      0x25, 0x7F,        // Logical maximum (127)

      0x75, 8,        // Report size = 8 (bits)
      0x95, USB_EP1_TX_SIZE,        // Report count = 16 bits (2 bytes)
      0x81, 2,        // Input (Data, Var, Abs)
      0x19, 1,        // Usage minimum
      0x29, USB_EP1_RX_SIZE,        // Usage maximum
      0x75, 8,        // Report size = 8 (bits)
      0x95, USB_EP1_RX_SIZE,        // Report count = 16 bits (2 bytes)
...
//////////////////////////////////////////////////////////////////
   ...
   //endpoint descriptor
         ...
         1,  //polling interval, in ms.  (cant be smaller than 10)      ==34 //250
   ...
   //endpoint descriptor
         ...
         10 //polling interval, in ms.  (cant be smaller than 10)    ==41 //10
   };
